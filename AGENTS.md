...
└── Advanced-Mathematics/      # Chapter-by-chapter notes
    ├── Ch01_Function_Limit_Continuity.md
    ├── Ch02_Derivative_Differential.md
    ├── Ch03_Mean_Value_Theorem_Applications.md
    └── [Future_Chapters].md
```
...
### ② 必考题型分类与母题演练 (Core Exam Question Types)
At least 5 standard question types. Each type must include:
- **题型名称**
- **识别特征** (2-3 keywords/conditions that trigger this method)
- **通法步骤** (Step-by-step algorithmic solution)
- **常见陷阱** (Where students lose points)
- **【经典母题 & 解析】** — 1 exam-level problem per type, focus on "why this step works"
